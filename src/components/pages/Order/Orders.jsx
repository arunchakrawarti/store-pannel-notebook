      ...
      <div className="flex-1 flex flex-col gap-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            type="number"
            defaultValue={1}
            className="w-16 border border-gray-300 cursor-pointer rounded px-2 py-1 text-center focus:ring-2 focus:ring-blue-500"
          />
        </div>

        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="add-to-card">
            <button className="bg-[#2E3192] text-white cursor-pointer font-urbanist font-semibold px-15 py-3 rounded hover:bg-blue-800 transition">
              Buy Now
            </button>
          </Link>
