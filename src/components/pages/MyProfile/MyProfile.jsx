...
const MyProfile = () => {
  return (
    <div className="container mx-auto pt-37">

      <h1 className="font-inter font-semibold text-black text-[20px] sm:text-[24px] leading-tight mb-6">
        My Profile
      </h1>
      ...
      <div className="w-full border border-gray-300 rounded-md overflow-hidden">
        ...
        <div className="p-4 sm:p-6">
          <h2 className="font-poppins font-semibold text-[16px] sm:text-[18px] text-black mb-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-10 gap-4 flex-wrap">
            ...
            <div className="flex items-center  gap-1 min-w-0">
              <Input label="Name" placeholder="Enter Name" className="text-black" />
            </div>


            <div className="flex items-center gap-1 min-w-0">
              <Input label="Phone" placeholder="Enter phone no" />
            </div>
