    ...
    <div className="w-full pt-33 max-w-[1400px] mx-auto px-4 lg:px-16 py-10 grid md:grid-cols-3 gap-6">
      <div className="md:col-span-2 border border-gray-300 rounded-lg p-4">
        ...
        <div className="flex justify-between mt-5">
          <button className="px-4 py-2 border cursor-pointer border-[#2E3192] text-[#2E3192] rounded-lg text-sm">
            Back to Store
          </button>

          <button className="px-4 py-2 border border-[#2E3192] text-[#2E3192] cursor-pointer rounded-lg text-sm">
            Clear Cart
          </button>
        </div>
      </div>
      ...
      <div className="border border-gray-300 rounded-lg p-5 h-fit sticky top-4">
        ...
        <div className="space-y-5  text-sm">
          ...
          <button className="w-full mt-4 bg-green-600 hover:bg-green-700 text-white cursor-pointer font-inter text-[16px] leading-[24px] py-3 rounded-lg">
            Proceed To Checkout
          </button>
        </div>
      </div>
